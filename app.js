...
app.post('/channels/:channelName/chaincodes/:chaincodeName', async function (req, res) {
	...
	try {
		...
		args.push(id, req.body.name, req.body.placeofbirth, req.body.dob, req.body.gender, req.body.father_name, req.body.mother_name, req.body.address_birth, req.body.address, req.body.hospital_name, req.body.weight );
		...
		console.log(peers, channelName, chaincodeName, fcn, args, req.username, req.orgname);
